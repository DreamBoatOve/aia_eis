...
if rank == 0:
    ...
    para_list = []
    max_iter_list = [13000, 15000]
    alpha_init_list = [10 ** (-i) + 0.0 for i in range(6)] + [10, 100, 1000]
    ...
    print('Process-{0} got parameters and starts working')
    ...
    for para in rec_para_list:
        ...
        res_file_name = date_str + 'linear_alpha_mpi.txt'
...
Plan-1
    ...
    2-Run the file
        Use 'cmd' in the folder containing this file, then type the following command:
            mpiexec -n 16 python lrc_ovo_main_mpi.py
"""