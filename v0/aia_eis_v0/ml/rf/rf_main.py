...
from ml.rf.rf_0 import RF, save_random_forest, load_random_forest
from ml.ml_critrions import cal_accuracy, cal_kappa, cal_accuracy_on_2, cal_accuracy_on_3
from ml.ml_data_wrapper import pack_list_2_list
...
#                             w_type='w')
plot_RF_Lime_Weight_Avg_Var(fp='../../ml/rf/rf_res/lime_res', fn='2021_01_24_lime_explain_res.txt',
                            w_type='abs')
