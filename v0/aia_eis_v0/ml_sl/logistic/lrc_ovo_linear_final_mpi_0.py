...
if rank == 0:
    ...
    para_list = []
    selected_para_list = [[5000, 10], [5000, 100], [5000, 1000], [7000, 100], [7000, 1000]]
    ...
    for para in rec_para_list:
        ...
        lrc_classifer_dict_pickle_filename = date_str + 'lrc_ovo_linear_final_iter='+ str(max_iter) + '_alpha_init='\
        ...
        res_file_name = date_str + 'ovo_linear_final.txt'
...
Plan-1
    ...
    2-Run the file
        Use 'cmd' in the folder containing this file, then type the following command:
            mpiexec -n 16 python lrc_ovo_linear_final_mpi_0.py
"""